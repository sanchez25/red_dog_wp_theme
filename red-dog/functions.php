...
function my_scripts(){
	...
	wp_enqueue_script( 'tween', get_template_directory_uri() . '/js/plugins/TweenMax.min.js', array(), '2.0.2', true );
	wp_enqueue_script( 'magic', get_template_directory_uri() . '/js/plugins/ScrollMagic.js', array(), '2.0.7', true );
	wp_enqueue_script( 'animation', get_template_directory_uri() . '/js/plugins/animation.gsap.js', array(), '2.0.7', true );
